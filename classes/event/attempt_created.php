...
/**
 * The attempt_created event class.
 *
 * @package    mod_aireading
 * @copyright  2025 ISB Bayern
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class attempt_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_attempt_created', 'mod_aireading');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' created attempt '{$this->other['attemptnumber']}' " .
